 ...
 */
export interface SequencePart<T extends PartReference> extends Part {
    sequence: T[];
}
 ...
 */
export interface SwitchSequencePart extends SequencePart<WhenPartReference> {
 ...
 * Sequence Part definition
 */
export interface TemplatePart extends Part {
    elements: Element[];
    attachTo?: AttachTemplate[];
}


export interface ForEachPart extends Part {
 ...
 */
export interface ComponentPart extends Part {
    componentId: string;
}
